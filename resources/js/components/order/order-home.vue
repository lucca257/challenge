<template>
  <div class="order-home" v-if="!order_view">
    ...
    <div class="container" v-else>
      <div class="card" style="margin-bottom: 25px">
        ...
        <div class="card">
          <div class="card-header">Adicione um novo pedido</div>
          <div class="card-body">
            <form @submit.prevent="submit">
              ...
              >
                ...
                <div class="form-group col-md-3">
                  ...
                  <select
                    name="quantity"
                    id="quantity_id"
                    class="form-control ml-sm-4 mr-sm-4 my-2"
                    v-model="input.quantaty"
                    v-on:change="calculateTotalPrice"
                  >
              ...
              <div class="col-md-10">
                <p
                  class="text-right mt-3 mr-5 mr-sm-3 font-weight-bold text-uppercase"
                >
                  total da compra: R$ {{ this.totalPrice }}
                </p>
              </div>
            </form>
          </div>
  ...
  <div v-else>
    <order-details :order="order_view" :client_name="order_client_name" />
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    searchAmountProduct(product_id) {
      const { amount } = this.products.find(
